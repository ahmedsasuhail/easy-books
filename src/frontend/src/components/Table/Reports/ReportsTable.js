          ...
          <>
            ...
            <TableBody>
              {(props.relationshipRows
                ...
                <>
                  <TableRow className={classes.rowBgColor}>
                    ...
                    <TableCell
                      className={classes.headCellSuccess}
                      align="right"
                    >
                      {props.purchaseRows
                            ...
                            >
                              ...
                              <TableBody>
                                ...
                                {props.relationshipRows &&
                                  ...
                                  props.relationshipRows.sales.map(
                                    (item, idx) => (
                                      <TableRow key={idx}>
                                        <TableCell>{item.part_name}</TableCell>
                                        <TableCell align="right">
              ...
              {(props.relationshipRows || props.rangeRows) &&
                (props.rangeRows
                  ? props.rangeRows.purchased_total > 0
                  : true) &&
                (props.relationshipRows
                  ...
                  <>
                    <TableRow className={classes.rowBgColor}>
                      ...
                      <TableCell
                        className={classes.headCellError}
                        align="right"
                      >
                        {props.relationshipRows
                          ? props.relationshipRows.purchased_total
